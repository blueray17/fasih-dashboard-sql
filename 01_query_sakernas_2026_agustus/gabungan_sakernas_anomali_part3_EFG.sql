...
SELECT 'E' AS kelompok_cek,
       ...
       dem_age,
       CONCAT('mjj_emprel_value: ', mjj_emprel_value, '; ', 'mjj_kbji_value: ', mjj_kbji_value, '; ', 'sjj_emprel_value: ', sjj_emprel_value, '; ', 'sjj_kbji_value: ', sjj_kbji_value, '; ', 'mpk_status_value: ', mpk_status_value, '; ', 'mpk_kbji_value: ', mpk_kbji_value, '; ') AS detail_cek,
...
SELECT 'F' AS kelompok_cek,
       ...
       art.dem_name AS NAMA_ART,
       dem_age,
       CONCAT('mjj_emprel_value: ', mjj_emprel_value, '; ', 'mjj_kbli_value: ', mjj_kbli_value, '; ', 'sjj_emprel_value: ', sjj_emprel_value, '; ', 'sjj_kbli_value: ', sjj_kbli_value, '; ', 'mpk_status_value: ', mpk_status_value, '; ', 'mpk_kbli_value: ', mpk_kbli_value, '; ') AS detail_cek,
       CONCAT('PML: ',p.PML,'; PPL: ',p.PPL,'; Status: ',base.assignment_status_alias) AS petugas,
       LTRIM( STUFF( CONCAT( a1.anomali, a2.anomali, a3.anomali ) ,1,1,'') ) AS anomali,
       root.catatan,
       art.assignment_id AS Link,
